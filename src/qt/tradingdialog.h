...
private slots:
    ...
    QString BuyYOBA(QString OrderType, double Quantity, double Rate);
    QString SellYOBA(QString OrderType, double Quantity, double Rate);
